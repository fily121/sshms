...
//            this.addTestRouter();
    ...
    public void doResponse(HttpServletRequest request, HttpServletResponse response, IWechatService wechatService) throws ServletException, IOException {
        ...
        if ("raw".equals(encryptType)) {
            ...
            response.getWriter().print("不可识别的加密类型");
            return;
        }

        wechatService.processRequest(inMessage);
    }
}
