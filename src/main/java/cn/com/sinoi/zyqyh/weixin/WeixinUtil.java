...
public class WeixinUtil {
    ...
    public final static String access_token_url = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=CorpID&secret=SECRET"; // "https://qyapi.weixin.qq.com/cgi-bin/gettoken?corpid=CorpID&corpsecret=SECRET";
    ...
    // 菜单创建（POST）
    public static String menu_create_url = "https://qyapi.weixin.qq.com/cgi-bin/menu/create?access_token=ACCESS_TOKEN&agentid=AGENT_ID";
...
//
//        // 拼装创建菜单的url
//        String url = menu_create_url.replace("ACCESS_TOKEN", accessToken).replace("AGENT_ID", agentid);
//        // 将菜单对象转换成json字符串
