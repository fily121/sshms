...
public class OAuth2Core {
	 ...
	 * */
	public static String getCode(String corpId, String redirect_uri) {
		String get_code_url = "";
		get_code_url = GET_CODE.replace("CORPID", corpId).replace("REDIRECT_URI", WeixinUtil.URLEncoder(redirect_uri));
		return get_code_url;
	}
