package cn.com.sinoi.wechat.contacts;
...
public class Person {
	 ...
	 *            微信号。企业内必须唯一
	 * */
	public static String create(String userid, String name, String position, String mobile, String tel, String email, String weixinid) {
		String postData = "{\"userid\": %s,\"name\": %s,\"department\": [1, 2],\"position\": %s,\"mobile\": %s,\"tel\": %s,\"email\": %s,\"weixinid\": %s}";
		return String.format(postData, userid, name, position, mobile, tel, email, weixinid);
	}
