...
public class Group {
	 ...
	 *            父亲部门id。根部门id为1
	 * */
	public static String create(String name, String parentid, String id, String order) {
		String postData = "{\"name\": %s,\"parentid\": %s,\"id\": %s,\"order\": %s}";
		return String.format(postData, name, parentid, id, order);
	}
	 ...
	 *            部门id
	 * */
	public static String update(String name, String parentid, String id, String order) {
		String postData = "{\"name\": %s,\"parentid\": %s,\"id\": %s,\"order\": %s}";
		return String.format(postData, name, parentid, id, order);
	}
